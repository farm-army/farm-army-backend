...
module.exports = class stellaswap extends PancakePlatformFork {
  static MASTER_ADDRESS = "0xedfb330f5fa216c9d2039b99c8ce9da85ea91c1e"
  ...
  getMasterChefAddress() {
    return stellaswap.MASTER_ADDRESS;
  }

  async onFarmsBuild(farms) {
    farms.forEach(farm => {
      farm.main_platform = 'stellaswap';
      farm.platform = 'stellaswap';
    });
  }
};

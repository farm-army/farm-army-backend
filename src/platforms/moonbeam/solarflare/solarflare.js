...
module.exports = class solarflare extends PancakePlatformFork {
  static MASTER_ADDRESS = "0x995da7dfB96B4dd1e2bd954bE384A1e66cBB4b8c"
  ...
  getFarmLink(farm) {
    return 'https://app.solarflare.io/farm';
  }
  ...
  getMasterChefAddress() {
    return solarflare.MASTER_ADDRESS;
  }

  async onFarmsBuild(farms) {
    farms.forEach(farm => {
      farm.main_platform = 'solarflare';
      farm.platform = 'solarflare';
    });
  }
};

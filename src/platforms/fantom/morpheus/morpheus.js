...
module.exports = class morpheus extends PancakePlatformFork {
  static MASTER_ADDRESS = "0xc7dad2e953Dc7b11474151134737A007049f576E"
  ...
  getFarmLink(farm) {
    return farm.isTokenOnly === true
      ? 'https://morpheusswap.app/pools'
      : 'https://morpheusswap.app/farms';
  }
  ...
  getMasterChefAddress() {
    return morpheus.MASTER_ADDRESS;
  }
};

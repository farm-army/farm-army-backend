...
module.exports = class fortube extends LendBorrowPlatform {
  async getTokens() {
    ...
    const response = await Utils.requestJsonGet('https://api.for.tube/api/v1/bank/public/chain/BSC-Inno/markets');

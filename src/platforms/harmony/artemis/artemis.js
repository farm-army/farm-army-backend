...
module.exports = class artemis extends PancakePlatformFork {
  static MASTER_ADDRESS = "0x59C777cd749b307Be910f15c54A3116ff88f9706"
  ...
  getFarmLink(farm) {
    return 'https://app.artemisprotocol.one/earn';
  }
  ...
  getMasterChefAddress() {
    return artemis.MASTER_ADDRESS;
  }

  async onFarmsBuild(farms) {
    farms.forEach(farm => {
      farm.main_platform = 'artemis';
      farm.platform = 'artemis';
    });
  }
};

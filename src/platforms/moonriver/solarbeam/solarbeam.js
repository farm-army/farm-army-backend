...
module.exports = class solarbeam extends PancakePlatformFork {
  static MASTER_ADDRESS = "0xf03b75831397D4695a6b9dDdEEA0E578faa30907"
  ...
  getMasterChefAddress() {
    return solarbeam.MASTER_ADDRESS;
  }

  async onFarmsBuild(farms) {
    farms.forEach(farm => {
      farm.main_platform = 'solarbeam';
      farm.platform = 'solarbeam';
    });
  }
};

...
module.exports = class pcafeswap extends PancakePlatformFork {
  static MASTER_ADDRESS = "0xca2DeAc853225f5a4dfC809Ae0B7c6e39104fCe5"
  ...
  getFarmLink(farm) {
    return farm.isTokenOnly === true
      ? 'https://polygon.cafeswap.finance/pools'
      : 'https://polygon.cafeswap.finance/farms';
  }
  ...
  getMasterChefAddress() {
    return pcafeswap.MASTER_ADDRESS;
  }
};
